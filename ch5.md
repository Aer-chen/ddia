...
> 笔记：
>
> 对于主从机构的系统来说（集群或者分布式系统）。优缺点如下：
>
> 优点：
>
> - 高可用性：集群系统相对于单体系统来说更具有可用性
> - 高性能：一般都是主写从读，读写性能好
>
> :star: 缺点：
>
> - 消息延迟，消息缺失问题
> - 节点崩溃问题（leader崩溃，follower崩溃）
...
> 多主复制会出现的问题：
>
> 写入冲突：即多个leader对同一个数据进行改写造成的
>
> 解决方法：
>
> - 避免冲突：对于同一个用户，其操作都路由到同一个leader
> - 最终收敛：可以利用时间戳，大的时间戳会迭代掉小的时间戳
> - 自定义冲突：以git冲突类似
>
> 我觉得多主复制的问题
